...
**Live prototype:** open `index.html` in a browser, or enable GitHub Pages on this repo and use the published link. Two separate apps — a customer portal and an officer console — share one rule engine and one set of demo data.
...
This is the second case study in a series. The first, an **Order Management System**, follows the same structure and can be found in my other repositories.
